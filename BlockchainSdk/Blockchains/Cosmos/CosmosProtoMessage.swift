...
struct CosmosProtoMessage: Sendable {
    ...
    var hasDelegateContainer: Bool { return _delegateContainer != nil }
    /// Clears the value of `delegateContainer`. Subsequent reads from it will return its default value.
    mutating func clearDelegateContainer() { _delegateContainer = nil }
    ...
    var hasFeeAndKeyContainer: Bool { return _feeAndKeyContainer != nil }
    /// Clears the value of `feeAndKeyContainer`. Subsequent reads from it will return its default value.
    mutating func clearFeeAndKeyContainer() { _feeAndKeyContainer = nil }
    ...
    struct CosmosMessageDelegateContainer: Sendable {
        ...
        var hasDelegate: Bool { return _delegate != nil }
        /// Clears the value of `delegate`. Subsequent reads from it will return its default value.
        mutating func clearDelegate() { _delegate = nil }

        var stakingProvider: String = .init()
    ...
    struct CosmosMessageDelegate: Sendable {
        ...
        var hasDelegateData: Bool { return _delegateData != nil }
        /// Clears the value of `delegateData`. Subsequent reads from it will return its default value.
        mutating func clearDelegateData() { _delegateData = nil }
    ...
    struct CosmosMessagePublicKeyContainer: Sendable {
        ...
        var hasPublicKeyWrapper: Bool { return _publicKeyWrapper != nil }
        /// Clears the value of `publicKeyWrapper`. Subsequent reads from it will return its default value.
        mutating func clearPublicKeyWrapper() { _publicKeyWrapper = nil }
        ...
        var hasPublicKeyParamWrapper: Bool { return _publicKeyParamWrapper != nil }
        /// Clears the value of `publicKeyParamWrapper`. Subsequent reads from it will return its default value.
        mutating func clearPublicKeyParamWrapper() { _publicKeyParamWrapper = nil }
    ...
    struct DelegateData: Sendable {
        ...
        var delegatorAddress: String = .init()

        var validatorAddress: String = .init()
        ...
        var hasDelegateAmount: Bool { return _delegateAmount != nil }
        /// Clears the value of `delegateAmount`. Subsequent reads from it will return its default value.
        mutating func clearDelegateAmount() { _delegateAmount = nil }
    ...
    struct CosmosMessageFeeAndKeyContainer: Sendable {
        ...
        var hasPublicKeyContainer: Bool { return _publicKeyContainer != nil }
        /// Clears the value of `publicKeyContainer`. Subsequent reads from it will return its default value.
        mutating func clearPublicKeyContainer() { _publicKeyContainer = nil }
        ...
        var hasFeeContainer: Bool { return _feeContainer != nil }
        /// Clears the value of `feeContainer`. Subsequent reads from it will return its default value.
        mutating func clearFeeContainer() { _feeContainer = nil }
    ...
    struct CosmosMessagePublicKeyParamWrapper: Sendable {
        ...
        var hasPublicKeyParam: Bool { return _publicKeyParam != nil }
        /// Clears the value of `publicKeyParam`. Subsequent reads from it will return its default value.
        mutating func clearPublicKeyParam() { _publicKeyParam = nil }
    ...
    struct CosmosMessageFeeContainer: Sendable {
        ...
        var hasFeeAmount: Bool { return _feeAmount != nil }
        /// Clears the value of `feeAmount`. Subsequent reads from it will return its default value.
        mutating func clearFeeAmount() { _feeAmount = nil }
...
extension CosmosProtoMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try decoder.decodeSingularMessageField(value: &_delegateContainer)
            case 2: try decoder.decodeSingularMessageField(value: &_feeAndKeyContainer)
            case 3: try decoder.decodeSingularStringField(value: &chainID)
            case 4: try decoder.decodeSingularInt32Field(value: &accountNumber)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if accountNumber != 0 {
            try visitor.visitSingularInt32Field(value: accountNumber, fieldNumber: 4)
        }
...
extension CosmosProtoMessage.CosmosMessageDelegateContainer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularMessageField(value: &_delegate)
            case 2: try decoder.decodeSingularStringField(value: &stakingProvider)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !stakingProvider.isEmpty {
            try visitor.visitSingularStringField(value: stakingProvider, fieldNumber: 2)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CosmosProtoMessage.CosmosMessageDelegate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularStringField(value: &messageType)
            case 2: try decoder.decodeSingularMessageField(value: &_delegateData)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !messageType.isEmpty {
            try visitor.visitSingularStringField(value: messageType, fieldNumber: 1)
        }
...
extension CosmosProtoMessage.CosmosMessagePublicKeyContainer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularMessageField(value: &_publicKeyWrapper)
            case 2: try decoder.decodeSingularMessageField(value: &_publicKeyParamWrapper)
            default: break
            }
        }
    }
...
extension CosmosProtoMessage.CosmosMessagePublicKeyWrapper: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularStringField(value: &publicKeyType)
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !publicKeyType.isEmpty {
            try visitor.visitSingularStringField(value: publicKeyType, fieldNumber: 1)
        }
...
extension CosmosProtoMessage.CosmosMessagePublicKeyParam: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularInt32Field(value: &param)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if param != 0 {
            try visitor.visitSingularInt32Field(value: param, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CosmosProtoMessage.DelegateData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularStringField(value: &delegatorAddress)
            case 2: try decoder.decodeSingularStringField(value: &validatorAddress)
            case 3: try decoder.decodeSingularMessageField(value: &_delegateAmount)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !delegatorAddress.isEmpty {
            try visitor.visitSingularStringField(value: delegatorAddress, fieldNumber: 1)
        }
        if !validatorAddress.isEmpty {
            try visitor.visitSingularStringField(value: validatorAddress, fieldNumber: 2)
        }
...
extension CosmosProtoMessage.CosmosMessageFeeAndKeyContainer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularMessageField(value: &_publicKeyContainer)
            case 2: try decoder.decodeSingularMessageField(value: &_feeContainer)
            default: break
            }
        }
    }
...
extension CosmosProtoMessage.CosmosMessagePublicKeyParamWrapper: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularMessageField(value: &_publicKeyParam)
            default: break
            }
        }
    }
...
extension CosmosProtoMessage.CosmosMessageFeeContainer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularMessageField(value: &_feeAmount)
            case 2: try decoder.decodeSingularUInt64Field(value: &gas)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if gas != 0 {
            try visitor.visitSingularUInt64Field(value: gas, fieldNumber: 2)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CosmosProtoMessage.DelegateAmount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try decoder.decodeSingularStringField(value: &denomination)
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !denomination.isEmpty {
            try visitor.visitSingularStringField(value: denomination, fieldNumber: 1)
        }
        if !amount.isEmpty {
