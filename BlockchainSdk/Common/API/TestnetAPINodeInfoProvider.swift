...
struct TestnetAPINodeInfoProvider {
    ...
    func urls() -> [NodeInfo]? {
        ...
        case .bitcoin, .litecoin, .disChain, .rsk, .bitcoinCash, .binance, .cardano, .xrp, .ducatus, .tezos, .dogecoin, .solana, .kusama, .dash, .gnosis, .kaspa, .terraV1, .terraV2, .cronos, .octa, .playa3ullGames, .radiant, .joystream, .internetComputer:
            return nil
        }
    }
}
