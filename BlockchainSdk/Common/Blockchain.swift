    ...
    public func getJsonRpcEndpoints(keys: EthereumApiKeys) -> [RPCEndpoint]? {
        ...
        case .ethereum:
            if isTestnet {
                ...
                return [
                    ...
                    RPCEndpoint(url: URL(string: "https://eth.getblock.io/mainnet?api_key=\(getBlockApiKey)")!),
        ...
        case .ethereumClassic:
            if isTestnet {
                ...
                return [
                    RPCEndpoint(url: URL(string: "https://etc.getblock.io/mainnet?api_key=\(getBlockApiKey)")!),
        ...
        case .rsk:
            return [
                RPCEndpoint(url: URL(string: "https://rsk.getblock.io/mainnet?api_key=\(getBlockApiKey)")!),
        ...
        case .bsc:
            if isTestnet {
                ...
                return [
                    ...
                    RPCEndpoint(url: URL(string: "https://bsc.getblock.io/mainnet?api_key=\(getBlockApiKey)")!),
        ...
        case .polygon:
            if isTestnet {
                ...
                return [
                    ...
                    RPCEndpoint(url: URL(string: "https://matic.getblock.io/mainnet?api_key=\(getBlockApiKey)")!),
        ...
        case .avalanche:
            if isTestnet {
                ...
                return [
                    ...
                    RPCEndpoint(url: URL(string: "https://avax.getblock.io/mainnet/ext/bc/C/rpc?api_key=\(getBlockApiKey)")!),
        ...
        case .fantom:
            if isTestnet {
                ...
                return [
                    ...
                    RPCEndpoint(url: URL(string: "https://ftm.getblock.io/mainnet?api_key=\(getBlockApiKey)")!),
        ...
        case .gnosis:
            return [
                RPCEndpoint(url: URL(string: "https://gno.getblock.io/mainnet?api_key=\(getBlockApiKey)")!),
        ...
        case .optimism(let testnet):
            if testnet {
                ...
                return [
                    ...
                    RPCEndpoint(url: URL(string: "https://op.getblock.io/mainnet?api_key=\(getBlockApiKey)")!),
