...
final class BlockchainServiceManagerUtility {
    ...
    let sdkDerivations: [DerivationUnion] = [
        ...
        .init(path: "m/1852'/1815'/0'/0/0", blockchain: .cardano(shelley: false)),
    ...
    let sdkPublicKeysFromMnemonic: [PublicKeyUnion] = [
        ...
        .init(key: "5A3C15C97EE6632CB113F3A4E6465C93CBEA3E5A77E4CB063C5501FBE92C072B", blockchain: .cardano(shelley: false)),
