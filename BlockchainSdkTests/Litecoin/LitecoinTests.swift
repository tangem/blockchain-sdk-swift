...
class LitecoinTests: XCTestCase {
    ...
    func testBuildTransaction() {
        ...
        let buildToSignResult = txBuilder.buildForSign(transaction: tx, sequence: 4294967290, sortType: .none)!
        sizeTester.testTxSizes(buildToSignResult)
        let signedTx = txBuilder.buildForSend(transaction: tx, signatures: [signature1, signature2], sequence: 4294967290, sortType: .none)!
